namespace Lab8_LINQ
{
    partial class SearchProperties
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.searchParam.Items.Add("фамилия владельца");
            this.searchParam.Items.Add("марка автомобиля");
            this.searchParam.Items.Add("марка бензина");
            this.searchParam.Items.Add("мощность двигателя");
            //
            // valueLabel
            //
